...
## A week in MA22004 / MA52008

## Review of resources 

- MyDundee
- Module notes: both pdf and html
- Submitting labs: Gradescope / Turnitin
- Library: books!
- Lab resources: git repository


## Scheduling: Class test and changes

- Workshop on Thursday, in Dalhousie for week 1, moves to Tower Geography Lab from week 2
- Mock Exam in week 8 
- Now look at the Module Guide
...
::: {.column width="60%"}
![](images/labs.png){fig-alt="Screenshot of MA22004 / MA52008 lab 1."}
:::
...
- Share your top ideas to the Mentimeter poll [code: 1962 8481].

{{< qrcode https://www.menti.com/al68hk1jzvws qr1-1 width=120 height=120 colorDark='#4365e2' >}}
